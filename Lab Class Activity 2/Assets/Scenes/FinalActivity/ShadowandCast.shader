Shader "Custom/SimpleShadowsWithTexture"
{
Properties
{
...
// Simple shadow approximation using shadow map
half shadowAmount = MainLightRealtimeShadow(IN.shadowCoords);
// Combine the texture color with shadow information
return textureColor * shadowAmount;
}
ENDHLSL
}
// Shadow caster pass
